        ...
        <footer className='bg-[#222222] '>
            <div className='py-24 px-6 md:px-24 flex justify-between items-start flex-wrap flex-col md:flex-row gap-6 lg:gap-0'>
                <div className='w-[100%] md:w-[80%] lg:w-[25%] text-white'>
                    <h2 className='mb-6 text-[25px] font-bold text-[#ffcb34]'>JDM (Jewellery Designer Monoj)</h2>
            ...
            <div className='py-6 text-center text-white'>
                <h1 className='text-[12px] md:text-[15px] px-4'>Designed and Developed by <a href="https://souparnashee.com/" className=''>Souparno</a> © All rights reserved 2024</h1>
            </div>
        </footer>
    )
}
